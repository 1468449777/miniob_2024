...
{
public:
  TableGetLogicalOperator(Table *table, ReadWriteMode mode, bool need_copy_record = false);
  ...
  void set_need_copy_record(bool bool_value) { need_copy_record_ = bool_value; }
  bool need_copy_record() { return need_copy_record_; }

private:
  Table        *table_ = nullptr;
  ReadWriteMode mode_  = ReadWriteMode::READ_WRITE;
  bool          need_copy_record_{false};

...
RC VacuousTrx::update_record(Table *table, Record &record, char *new_record_data, int new_record_len) { return table->update_record(record, new_record_data, new_record_len); }
